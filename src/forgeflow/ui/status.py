...
STATUS_LABELS = {
    "pending": "대기", "running": "진행 중", "planning": "계획 중",
    "awaiting_approval": "승인 대기", "awaiting_review": "검토 대기",
    "completed": "완료", "succeeded": "실행 성공", "failed": "실패",
    "cancelled": "취소됨", "denied": "승인 거절", "approved": "승인됨",
    "accepted": "승인됨", "rejected": "반려됨", "verified": "검증 완료",
    "unavailable": "검증 정보 없음", "partial": "일부 검증", "skipped": "건너뜀",
}
